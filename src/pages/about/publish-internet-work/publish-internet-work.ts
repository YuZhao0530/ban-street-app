...
/**
 * Generated class for the PublishInternetWorkPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-publish-internet-work',
  templateUrl: 'publish-internet-work.html',
})
export class PublishInternetWorkPage {
  item = {
    title: '',
    address: '',
    notes: '',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PublishInternetWorkPage');
  }

  submitInfo(loading) {
    console.log('publish go!');
    this.publishService.publishInternetWork(this.item).then(
      (res) => {
