...
/**
 * Generated class for the PublishMallGoodsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-publish-mall-goods',
  templateUrl: 'publish-mall-goods.html',
})
export class PublishMallGoodsPage {
  item = {
    title: '',
    source: '',
    price: '',
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PublishMallGoodsPage');
  }

  submitInfo(loading) {
    console.log('publish go!');
    this.publishService.publishMallGoods(this.item).then(
      (res) => {
